...
from game.views import TeamCreateView, TournamentListView, TournamentDetailView, TournamentCreateView, TournamentDeleteView, TournamentTeamsListView, TeamDeleteView
